...
- 開發者Gijsbert Stoet發表於Teaching of Psychology的論文[@stoetPsyToolkitNovelWebBased2017]，使用Psytoolkit完成的研究報告務必引用這份論文。
...
- 任何使用者可經[官方登入頁面](https://www.psytoolkit.org/#_web_based_login)免費註冊帳號，線上管理與執行問卷與實驗腳本。官方登入頁面連結為最新版本。

## 登入畫面介紹

![2020年春季登入畫面截圖。實際畫面以官方網站為準。](includes/img/Psytoolkit_login.png)  
