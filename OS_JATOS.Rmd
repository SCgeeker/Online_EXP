...
**註** 如果要在[Prolific](https://app.prolific.co/)招募參與者，可參考[JATOS官方說明](https://www.jatos.org/Use-Prolific.html)以及[OpenSesame使用者手冊](https://osdoc.cogsci.nl/3.3/manual/osweb/prolific/)，了解如何在Prolific與JATOS網站設定要存檔的參與者ID及網站紀錄。
