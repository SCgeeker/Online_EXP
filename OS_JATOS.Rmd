...
![](https://osdoc.cogsci.nl/3.3/pages/manual/osweb/img/prolific/jatos-url.png)
...
![](https://osdoc.cogsci.nl/3.3/pages/manual/osweb/img/prolific/prolific.png)

複製上圖最後一欄生成的網址。

4. 正式公開Prolific案件前，回到JATOS端案件儀表板，開啟'Property'分頁，將上一步最後複製的網址，貼在**End Redirect URL**欄位。完成後如同下圖：

![](https://osdoc.cogsci.nl/3.3/pages/manual/osweb/img/prolific/jatos-properties.png)
